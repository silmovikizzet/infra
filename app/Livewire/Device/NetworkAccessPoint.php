...
#[Title('Access Point')]
class NetworkAccessPoint extends Component
{
  use WithPagination;
  ...
  {
    $query = AssetAccessPoint::query()->with('credential');
  ...
  public function edit($id): void
  {
    ...
    $asset = AssetAccessPoint::with('credential')->findOrFail($id);
  ...
  public function update(): void
  {
    ...
    $asset = AssetAccessPoint::findOrFail($this->id);
    $asset->update([
      'hostname' => $this->hostname,
      'type' => $this->type,
      'ip_address' => $this->ip_address,
  ...
  {
    AssetAccessPoint::findOrFail($id)->delete();
  ...
  public function render()
  {
    ...
    return view('livewire.device.network-access-point', [
      'assets' => $assets,
    ]);
  }
}
