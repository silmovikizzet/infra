<div class="container-fluid p-0">
  <div class="d-flex align-items-start justify-content-between gap-3 mb-3">
    <div>
      <h4 class="mb-1">Network Firewall</h4>
    </div>
  ...
  {{-- Table --}}
  <div class="card">
    <h5 class="card-header">Firewall List</h5>
          ...
          <div class="modal-body">
            ...
            <div class="row g-3">
              ...
              <div class="col-md-4">
                ...
                <input type="text" class="form-control" wire:model.defer="hostname" placeholder="e.g. Fortigate">
              ...
              <div class="col-md-3">
                ...
                <input type="date" class="form-control" wire:model.defer="warranty">
