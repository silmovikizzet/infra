...
use App\Livewire\Network\VlanView as VlanView;
use App\Livewire\Network\DhcpSite as DhcpSite;
use App\Livewire\Network\DhcpView as DhcpView;
use App\Livewire\Network\IpSite as IpSite;
...
use App\Livewire\Tools\NetworkApImporter;
/**
 * 1) Public routes (guest only)
 * - kalau user sudah login, akses login/register diarahkan ke dashboard
 */
...
Route::middleware('auth')->group(function () {
  ...
  Route::get('/network/vlan', VlanSite::class)->name('network.vlan');
  Route::get('/network/vlan/{vlanId}', VlanView::class)->name('network.vlan.id');
  Route::get('/network/dhcp', DhcpSite::class)->name('network.dhcp');
  Route::get('/network/dhcp/{dhcpPoolId}', DhcpView::class)->name('network.dhcp.id');
  Route::get('/network/ipaddress', IpSite::class)->name('network.ipaddress');
  ...
  Route::get('/tools/ap-importer', NetworkApImporter::class)->name('ap.import');
});
